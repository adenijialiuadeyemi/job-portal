...
const AddJob = () => {
  ...
  const [category, setCategaory] = useState("Programming");
  ...
  return (
    <form className="container flex gap-3 p-4 flex-col w-full items-start">
      ...
      <div className="flex flex-col sm:flex-row gap-2 w-ful sm:gap-8">
        <div>
          ...
          <select
            ...
            onChange={(e) => setCategaory(e.target.value)}
          >
